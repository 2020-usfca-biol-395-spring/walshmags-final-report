...
#map that compares the diesel pm2.5 pollution and asthma ed visit rate in the cesus
#tracts of San Francisco
...
```{r race-asthma-plot}
#plot graph
ggplot(data = asthma_summary, aes(x = `STRATA NAME`, y = `Asthma ED Visit Rate`)) +
